...
On the Intel Core i5-10210U (measured baseline, this project):
- Peak theoretical throughput: 268.8 GFLOP/s (Intel ARK, AVX2, boost 4.2 GHz, float32)
- Peak memory bandwidth: 45.8 GB/s (DDR4-2667, dual-channel)
- Ridge point = 268.8 / 45.8 = **5.9 FLOP/byte**

Our kernel's AI = 46.9 FLOP/byte is **far above the ridge point (5.9 FLOP/byte)**,
...
This is within the expected range for a quad-core i5-10210U running PyTorch with
MKL/OpenBLAS-backed conv2d (~53% of AVX2 peak) — confirming the kernel is
operating compute-bound.
...
| CPU ridge point (i5-10210U) | 5.9 FLOP/byte (268.8 GFLOP/s ÷ 45.8 GB/s) |
| Bound type (CPU) | Compute-bound (AI 46.9 >> ridge 5.9) |
